...
- [x] It should be able to list organization invites;
- [x] It should be able to list user pending invites;
- [x] It should be able to accept an invite;
- [x] It should be able to reject an invite;
...
- [x] It should be able to remove a member from organization;
